...
(function() {
        ...
        if (a === b)
            ...
            a: {
                ...
                if (k && !p)
                    ...
                    if (!(c & 1) && (f = p && ic.call(a, "__wrapped__"),
                            ...
                            if (p && v)
                                ...
                                for (var I = f; ++k < h; ) {
                                    ...
                                    var m = a[v]
                                      , r = b[v];
                                    if (e)
                                        var M = f ? e(r, m, v, b, a, d) : e(m, r, v, a, b, d);
    ...
    function qc(a) {
        try {
            return ta.removeItem(a),
            ta.removeItem(a + ".expires"),
            !0
        } catch (b) {
            return !1
        }
    ...
    function td(a, b, c, e, d) {
        function f(e, f, h) {
            h = h || {};
            g.hasOwnProperty(e) ? A("Tracker namespace " + e + " already exists.") : (g[e] = new a(d,e,b,c,h),
                ...
                if ("newTracker" === c)
                    ...
                    if (d && 0 !== d.length)
                        for (var h = 0; h < d.length; h++)
                            g.hasOwnProperty(d[h]) ? e.push(g[d[h]]) : A('Warning: Tracker namespace "' + d[h] + '" not configured');
                    else
                        e = da(g);
                    ...
                    d = b[0],
                    b = b[1],
                    A(c + " is deprecated. Set the collector when a new tracker instance using newTracker."),
                    b = void 0 === b ? "sp" : b,
                    f(b),
                    g[b][c](d)
            }
    ...
    function ud() {
        ...
        if (!a)
            return !1;
        try {
            return ua.localStorage.setItem("modernizr", "modernizr"),
    ...
    function vd() {
        var a = ua
          , b = "inner";
        "innerWidth"in ua || (b = "client",
        a = qb.documentElement || qb.body);
        var c = a[b + "Width"];
        a = a[b + "Height"];
            ...
            addClickListeners: function() {
                ...
                for (c = 0; c < a.length; c++)
                    if (f(a[c]) && !a[c][b]) {
                        var e = a[c];
                        h ? (u(e, "mouseup", d(k), !1),
                        u(e, "mousedown", d(k), !1)) : u(e, "click", d(k), !1);
                        a[c][b] = !0
                    }
            }
        }
                ...
                O(document.getElementsByTagName("form"), function(b) {
                    v(b) && !b[p] && (O(k, function(c) {
                        O(b.getElementsByTagName(c), function(b) {
                            I(b) && !b[p] && "password" !== b.type.toLowerCase() && (u(b, "focus", h("focus_form", a), !1),
                            u(b, "change", h("change_form", a), !1),
                            b[p] = !0)
                        })
                    }),
                    u(b, "submit", g(a)),
    ...
    function Dd(a, b, c, e, d, f, h, g, k, p, v, I) {
        ...
        function F() {
            for (; E.length && "string" !== typeof E[0] && "object" !== y(E[0]); )
                E.shift();
            if (1 > E.length)
                q = !1;
            else {
    ...
    function Nd(a) {
        ...
        if (W(a) && "[object Object]" == Q(a)) {
            var c = Od(a);
            null === c ? c = !0 : (c = Pd.call(c, "constructor") && c.constructor,
    ...
    function wb(a, b, c, e, d) {
        ...
        function k(a) {
            for (var b = 0; b < B.links.length; b++) {
                var c = B.links[b];
                !c.spDecorationEnabled && a(c) && (u(c, "click", g, !0),
                u(c, "mousedown", g, !0),
        ...
        function L(a, b, c) {
            if (!za || zb)
                "localStorage" == G ? Vb(a, b, c) : ("cookie" == G || "cookieAndLocalStorage" == G) && N(a, b, c, Ba, yb, ja, la)
        }
        function P(a) {
        ...
        function x(a) {
            ...
            if (C.optimizely) {
                H.optimizelySummary && (a = ua(),
                O(a, function(a) {
                    b.push(a)
                }));
                H.optimizelyXSummary && (a = va(),
                O(a, function(a) {
                    b.push(a)
                }));
        ...
        function ma() {
            !Fb && S.geolocation && S.geolocation.getCurrentPosition && (Fb = !0,
        ...
        function Ia(a, b, c, d, e) {
            ...
            if (T.enabled && (wb || e)) {
                ...
                for (var g in T.configurations)
                    T.configurations.hasOwnProperty(g) && (d = T.configurations[g],
        ...
        var Ca = function(a) {
            ...
            m = l,
            R = J()),
            aa = k) : (new Date).getTime() - Xa > 1E3 * Ja && (R = J(),
            aa++),
            a.add("vp", vd()),
            a.add("ds", wd()),
            a.add("vid", zb ? aa : za ? null : aa),
            a.add("sid", zb ? R : za ? null : R),
            a.add("duid", za ? null : g),
            a.add("uid", za ? null : Ta),
            h(),
            a.add("refr", p(ea || Ob)),
            a.add("url", p(Bb || ya)),
            "none" != G && (y(g, Vd, aa, b, m, R),
            w()),
            Xa = (new Date).getTime());
            b = vb;
            c = new Date;
            f = Qb ? !!N(Qb) : !1;
            Ea || f || (Sa.enqueueRequest(a.build(), Rb),
            e.expireDateTime = c.getTime() + b)
        }), Ga = !1, l = {}, sa = {}, Ka = {}, B = document, C = window, S = navigator, Pa = sc(B.domain, C.location.href, ec()), Ma = dc(Pa[0]), ya = Pa[1], Ob = Pa[2], ea, qb = d.hasOwnProperty("platform") ? d.platform : "web", Rb, rb = d.hasOwnProperty("postPath") ? d.postPath : "/com.snowplowanalytics.snowplow/tp2", sb = d.hasOwnProperty("appId") ? d.appId : "", Bb, Ab = B.title, Pb, vb = d.hasOwnProperty("pageUnloadTimer") ? d.pageUnloadTimer : 500, wb = d.hasOwnProperty("resetActivityTrackingOnPageView") ? d.resetActivityTrackingOnPageView : !0, Va, Ya, Qa = d.hasOwnProperty("cookieName") ? d.cookieName : "_sp_", yb = d.hasOwnProperty("cookieDomain") ? d.cookieDomain : null, Ba = "/", ja = d.hasOwnProperty("cookieSameSite") ? d.cookieSameSite : "None", la = d.hasOwnProperty("cookieSecure") ? d.cookieSecure : !0, ib = S.doNotTrack || S.msDoNotTrack || C.doNotTrack, Ea = d.hasOwnProperty("respectDoNotTrack") ? d.respectDoNotTrack && ("yes" === ib || "1" === ib) : !1, Qb, lb, nb = d.hasOwnProperty("cookieLifetime") ? d.cookieLifetime : 63072E3, Ja = d.hasOwnProperty("sessionCookieTimeout") ? d.sessionCookieTimeout : 1800, Jb = B.characterSet || B.charset, ob = d.hasOwnProperty("forceSecureTracker") ? !0 === d.forceSecureTracker : !1, Lb = !ob && d.hasOwnProperty("forceUnsecureTracker") ? !0 === d.forceUnsecureTracker : !1, zb = Da(d), Na = Fa(d), za = !!d.anonymousTracking, tb = d.hasOwnProperty("useLocalStorage") ? (A("argmap.useLocalStorage is deprecated. Use argmap.stateStorageStrategy instead."),
        d.useLocalStorage) : !0, Oa = d.hasOwnProperty("useCookies") ? (A("argmap.useCookies is deprecated. Use argmap.stateStorageStrategy instead."),
        d.useCookies) : !0, G = Ca(d), Nb = S.userLanguage || S.language, ac = xd(), ub = a + "_" + b, Wb, Xa = (new Date).getTime(), Xb, Yb, Zb, $b, Sb = Xd, Ra, xb, R, aa = 1, Ta, Za, $a, ab, bb, cb, db, eb, fb, gb, hb, jb, bc = [], Cb = new yd(t,ub,x), cc = new zd(t,ub,x), Eb = new Bd(t), Sa = new Dd(a,b,e,"localStorage" == G || "cookieAndLocalStorage" == G,d.eventMethod,rb,d.bufferSize,d.maxPostBytes || 4E4,d.useStm,d.maxLocalStorageQueueSize || 1E3,d.connectionTimeout || 5E3,Na), Fb = !1, H = d.contexts || {}, kb = [], Db = [], Gb = !1, Hb = !1, T = {
            enabled: !1,
            installed: !1,
            configurations: {}
        }, Aa = null;
        ...
        for (var ba in ac)
            Object.prototype.hasOwnProperty.call(ac, ba) && ("res" !== ba && "cd" !== ba && "cookie" !== ba || f(ba) ? f(ba) || t.addPayloadPair("f_" + ba, ac[ba]) : t.addPayloadPair(ba, ac[ba]));
        m();
        X();
        ...
        l.setCustomUrl = function(a) {
            h();
            var b = ya, c;
            v(a) ? Bb = a : "/" === a.slice(0, 1) ? Bb = v(b) + "://" + Ub(b) + a : (b = p(b),
        ...
        l.enableLinkClickTracking = function(a, b, c, d) {
            ...
            Cb.addClickListeners()) : e.registeredOnLoadHandlers.push(function() {
        ...
        l.enableActivityTracking = function(a, b) {
            T.configurations.pagePing || (T.enabled = !0,
            T.configurations.pagePing = xa(a, b, Wa))
        }
        ;
        l.enableActivityTrackingCallback = function(a, b, c) {
            T.configurations.callback || (T.enabled = !0,
            T.configurations.callback = xa(a, b, c))
        }
        ;
        ...
        l.enableFormTracking = function(a, b) {
            e.hasLoaded ? (cc.configureFormTracking(a),
            cc.addFormListeners(b)) : e.registeredOnLoadHandlers.push(function() {
    ...
    function Ic(a, b) {
        function c() {
            ...
            if (!h.hasLoaded)
                for (h.hasLoaded = !0,
                a = 0; a < h.registeredOnLoadHandlers.length; a++)
        ...
        function e() {
            ...
            d.addEventListener ? u(d, "DOMContentLoaded", function p() {
                ...
                "complete" === d.readyState && (d.detachEvent("onreadystatechange", p),
                c())
            }),
    ...
    var ie = function(a) {
      ...
      , Ia = function(a) {
        if (fa(a)) {
            ...
            f = c.length;
            for (var k in a)
                !ke.call(a, k) || b && ("length" == k || e && ("offset" == k || "parent" == k) || d && ("buffer" == k || "byteLength" == k || "byteOffset" == k) || Xa(k, f)) || c.push(k);
            a = c
        } else if (k = a && a.constructor,
        a === ("function" == typeof k && k.prototype || le)) {
            k = [];
            for (e in Object(a))
                ne.call(a, e) && "constructor" != e && k.push(e);
            a = k
        } else
            a = me(a);
        return a
    ...
    V.prototype.get = function(a) {
        var b = this.__data__;
        return Da ? (a = b[a],
        "__lodash_hash_undefined__" === a ? void 0 : a) : te.call(b, a) ? b[a] : void 0
    }
    ;
    ...
    var ve = function(a, b) {
      ...
      , hc = function(a, b, c, e, d, f) {
        ...
        for (f.set(b, a); ++k < g; ) {
            var q = a[k]
              , m = b[k];
            if (e)
                var r = h ? e(m, q, k, b, a, f) : e(q, m, k, a, b, f);
            if (void 0 !== r) {
                if (r)
                    continue;
                p = !1;
      ...
      , nd = function(a, b, c, e, d, f, h) {
        ...
        case "[object ArrayBuffer]":
            if (a.byteLength != b.byteLength || !f(new Xc(a), new Xc(b)))
                break;
            return !0;
        case "[object Boolean]":
        case "[object Date]":
    ...
    : ye
      ...
      , Ee = ha(eb)
      , ka = Q;
    if (bb && "[object DataView]" != ka(new bb(new ArrayBuffer(1))) || Ca && "[object Map]" != ka(new Ca) || cb && "[object Promise]" != ka(cb.resolve()) || db && "[object Set]" != ka(new db) || eb && "[object WeakMap]" != ka(new eb))
        ka = function(a) {
            var b = Q(a);
            if (a = (a = "[object Object]" == b ? a.constructor : void 0) ? ha(a) : "")
                switch (a) {
                case Ae:
    ...
    var Ke = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g
      ...
      , Ye = function(a) {
        ...
        if (Ka(a))
            return dd;
        P(a) && (a = "function" == typeof a.valueOf ? a.valueOf() : a,
        a = P(a) ? a + "" : a);
        if ("string" != typeof a)
            return 0 === a ? a : +a;
        a = a.replace(Te, "");
      ...
      , fc = function(a) {
        a ? (a = Ye(a),
        a = a === ed || a === -ed ? 1.7976931348623157E308 * (0 > a ? -1 : 1) : a === a ? a : 0) : a = 0 === a ? a : 0;
        var b = a % 1;
